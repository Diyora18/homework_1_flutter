...
import '../managers/recipes_view_model.dart';
...
class CategoryDetailsRecipe extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => RecipeLunchModel()..fetchRecipeDetails(recipeId),
      child: Consumer<RecipeLunchModel>(
        builder: (context, vm, _) {
          ...
          return Scaffold(
            ...
            // appBar: RecipeAppBarMain(toolbarHeight: 55, title: title),
